function [ output ] = reconstruct ( comp_factor )
% single channel jpeg compression without encoding of lake image luminance
...
for count1 = 1 : counter_row
	...
	for count2 = 1 : counter_column
		...
		result ( row : row + 7 , column : column + 7 ) = idct_image;
